...
type FilterChildrenBy<
  Status extends string | number | (() => void),
  ExcludedValue extends string | number | Function
> = ExcludedValue extends "naughty" | "nice"
  ? "nice"
  : ExcludedValue extends Function
  ? string | number
  : Status;
